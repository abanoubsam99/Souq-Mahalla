...
class SpecialOfferDetailsScreen extends StatefulWidget {
  ...
  @override
  _SpecialOfferDetailsScreenState createState() =>
      _SpecialOfferDetailsScreenState();
}
              ...
              child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Column(crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                    Text("تيشرت رجالى مستورد",style: TextStyle(color: Colors.black,fontSize: 16,fontWeight: FontWeight.bold),),
                    Padding(
...
final List<String> _imgList = [
  'https://image.freepik.com/free-photo/attractive-woman-wearing-hat-posing-black-background_7502-7664.jpg',
  'https://image.freepik.com/free-photo/pretty-girl-with-trendy-hair-make-up-looking-camera_7502-8927.jpg',
  'https://image.freepik.com/free-photo/photo-young-pretty-fashionable-girl-who-s-reading-book-white-park-s-bench-she-wears-light-colored-clothes-jeans-t-shirt-cardigan-also-she-wears-backpack-eyeglasses_7502-8595.jpg',
