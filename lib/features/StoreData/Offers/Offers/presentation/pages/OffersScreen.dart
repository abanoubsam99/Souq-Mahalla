...
import 'package:untitled9/features/StoreData/Offers/AddOffer/presentation/pages/AddOfferScreen.dart';
import 'package:untitled9/features/StoreData/Offers/EditeOffer/presentation/pages/EditeOfferScreen.dart';
import 'package:untitled9/features/StoreData/Offers/Offers/presentation/widgets/SearchOfferTextFild.dart';
    ...
    return Scaffold(
      ...
      body: Column(children: [
                ...
                child: Stack(
                    children: [
                      ...
                      Container(
                        ...
                        height:160,
                        decoration: BoxDecoration(
                          image: DecorationImage(image: NetworkImage("https://image.freepik.com/free-photo/beautiful-couple-having-their-wedding-beach_23-2149043952.jpg"),fit: BoxFit.cover),
                        ),
                      ),
                      Positioned(
                          top:10 ,
                          ...
                          Container(
                            ...
                            child: Center(child: IconButton(onPressed: (){
                              Navigator.push(
                                  context, MaterialPageRoute(builder: (context) => EditeOfferScreen()));
        ...
        InkWell(
          onTap: (){
            Navigator.push(
                context, MaterialPageRoute(builder: (context) => AddOfferScreen()));
          },
          child: Container(
