...
class AddCommunicateTextFild extends StatelessWidget {
   String hint;
  ...
  String _errorMessage(String error) {
    ...
    AddCommunicateTextFild({@required this.textEditingController,@required this.hint, @required this.textInputType,@required this.onclick});
