...
import 'package:untitled9/features/SellerProfile/presentation/widgets/ProfileItem.dart';
import 'package:untitled9/features/StoreData/StoreData/presentation/pages/StoreDataScreen.dart';
import 'package:untitled9/features/SubscriptionPlan/presentation/pages/SubscriptionPlan.dart';
                ...
                child: Container(
                  ...
                  child: Stack(children: [
                    Container(
                      width: 50,
                      height: 50,
                    child: Image.asset("assets/image/messages.png",color: Colors.black,),
                    ),
                    Positioned(
                      bottom: 9,
                      left: 9,
                      child: Container(
                        ...
                        child:Center(child: Text("5",style: TextStyle(color: Colors.white,fontSize: 10),),),
                      ),
                    )
                  ],),
                ),
          ...
          child: Directionality(
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.spaceAround,
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(50),
                  image: DecorationImage(image: NetworkImage("https://image.freepik.com/free-photo/young-handsome-man-choosing-clothes-shop_1303-19720.jpg"),
                      fit:BoxFit.cover )
                ),
              ),
              Column(mainAxisAlignment: MainAxisAlignment.center,
                children: [
                Text("ابانوب سامي ",style: TextStyle(color: Color(getColorHexFromStr("#515C6F")),fontSize:25,fontWeight: FontWeight.bold ),),
                Text("Abanoubsam@gmail.com",style: TextStyle(color: Color(getColorHexFromStr("#515C6F")),fontSize:14,fontWeight: FontWeight.normal ),),
                  SizedBox(height: 10,),
                  Container(
                    width: 120,
                    height: 30,
                    child: OutlineButton(
                      child: new Text("تعديل البروفايل",style:TextStyle(color: Color(getColorHexFromStr("#727C8E")),fontSize: 10,fontWeight: FontWeight.normal,decoration: TextDecoration.none),),
                      ...
                      onPressed: () {
                        Navigator.push(
                            context, MaterialPageRoute(builder: (context) => EditeProfileScreen()));
                           },
                    ),
                  ),
              ],)
          ...
          child: Container(
            ...
            child: Column(mainAxisAlignment: MainAxisAlignment.center,
              ...
              ProfileItem(
                ...
                function: (){
                  Navigator.push(
                      context, MaterialPageRoute(builder: (context) => StoreDataScreen()));
                },
              ),
              Padding(
              ...
              ProfileItem(
                ...
                function: (){
                  Navigator.push(
                      context, MaterialPageRoute(builder: (context) => SubscriptionPlan()));
                },
              ),
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 20),
            ...
            child: Column(mainAxisAlignment: MainAxisAlignment.center,
              children: [
                ProfileItem(
                  ...
                  function: (){
                    Share.share('https://play.google.com/store/apps/details?id=com.bis.bis_building&hl=ar&gl=US', subject: 'Look what I made!');
                  },
                ),
                Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 20),
                ...
                ProfileItem(
                  ...
                  function: (){
                    Navigator.push(
                        context, MaterialPageRoute(builder: (context) => TechnicalSupport()));
                  },
                ),
                Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 20),
            ...
            child: Column(mainAxisAlignment: MainAxisAlignment.center,
              children: [
                ProfileItem(
                  ...
                  function: (){
                    Navigator.push(
                        context, MaterialPageRoute(builder: (context) => AboutAppScreen()));
                  },
                ),
                Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 20),
