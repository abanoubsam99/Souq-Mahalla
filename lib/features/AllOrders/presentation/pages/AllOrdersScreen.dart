                    ...
                    child: Column(mainAxisAlignment: MainAxisAlignment.spaceAround,
                      ...
                      Row(mainAxisAlignment: MainAxisAlignment.spaceAround,
                        children: [
                            ...
                            child: OutlineButton(
                              ...
                              onPressed: () {
                                Navigator.push(
                                    ...
                                    status: i==0?"قيد التوصيل":i==1?"تم توصيله ":"تم الغاؤه",
                                  colorstate: i==0?Colors.amber:i==1?Colors.green:Colors.red,
                          ...
                          i==0?Text("قيد التوصيل ",style: TextStyle(color: Colors.amber,fontWeight: FontWeight.bold,fontSize: 13),)
                              :i==1?Text("تم توصيله ",style: TextStyle(color: Colors.green,fontWeight: FontWeight.bold,fontSize: 13),)
                              :Text("تم الغاؤه",style: TextStyle(color: Colors.red,fontWeight: FontWeight.bold,fontSize: 13),),
                        ],
                      ),
